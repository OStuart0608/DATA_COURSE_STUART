...
read_csv("C:/Users/Owner/Desktop/Biol 3100/DATA_COURSE_STUART/BIOL3100_Exams/Exam_1/cleaned_covid_data.csv")
  
  
  ##II.##
  ##Subset the data set to just show states that begin with "A" and save this as an object called A_states. (20 pts)##
  Exam_data <- read_csv("C:/Users/Owner/Desktop/Biol 3100/DATA_COURSE_STUART/BIOL3100_Exams/Exam_1/cleaned_covid_data.csv")
 view(Exam_data)
   A_states <- Exam_data %>%
